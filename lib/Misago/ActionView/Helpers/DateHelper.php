...
{
  if (!$from_time instanceof ActiveSupport\Datetime) $from_time = new ActiveSupport\Datetime($from_time);
  if (!$to_time   instanceof ActiveSupport\Datetime) $to_time   = new ActiveSupport\Datetime($to_time);
