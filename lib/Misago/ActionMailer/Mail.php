...
class Mail extends \Misago\Object
{
  public $action;
  ...
  {
    $this->action = $action;
    $this->from(cfg_get('action_mailer.default_email'));
  }
  ...
  function headers()
  {
    ...
    elseif (cfg_isset('action_mailer.return_path')) {
      $header['Return-Path'] = cfg_get('action_mailer.return_path');
    }
