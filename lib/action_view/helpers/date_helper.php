...
function distance_of_time_in_words($from_time, $to_time=0)
{
  ...
  elseif ($distance / 3600 < 24) {
    return t('about_x_hours', array('context' => 'number.datetime.distance_in_words', 'count' => round($distance / 3600)));
  }
  elseif ($distance / 3600 / 24 < 2) {
    return t('x_days', array('context' => 'number.datetime.distance_in_words', 'count' => 1));
  }
  elseif ($distance / 3600 / 24 < 30) {
    return t('x_days', array('context' => 'number.datetime.distance_in_words', 'count' => round($distance / 3600 / 24)));
  }
  ...
  elseif ($distance / 3600 / 24 / 30 < 12) {
    return t('about_x_months', array('context' => 'number.datetime.distance_in_words', 'count' => round($distance / 3600 / 24 / 30)));
  }
  elseif ($distance / 3600 / 24 / 30 / 12 < 2) {
    return t('x_years', array('context' => 'number.datetime.distance_in_words', 'count' => 1));
  }
  else {
