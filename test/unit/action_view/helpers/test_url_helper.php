...
class Test_ActionView_Helpers_UrlHelper extends Unit_Test
{
  ...
  function test_current_page()
  {
    ...
    $this->assert_true(current_page(new ActionController_PATH('GET', 'archives')));
    $this->assert_false(current_page(new ActionController_PATH('GET', 'articles')));
#    $this->assert_true(current_page(new ActionController_URL('GET', 'archives')));
#    $this->assert_false(current_page(new ActionController_URL('GET', 'archives/mine')));
